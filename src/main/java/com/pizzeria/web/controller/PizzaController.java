...
public class PizzaController {
    ...
    @Operation(summary = "Get all pizzas. ROLE NOT REQUIRED", description = "We are going to retrieve a list of all pizzas")
    @GetMapping()
    public ResponseEntity<List<PizzaEntity>> getAll(){
        return ResponseEntity.ok(this.pizzaService.getAllPizzas());
    }

    @Operation(summary = "Get pizzas by Pages and Elements. ROLE NOT REQUIRED", description = "We are going to retrieve a list of pizzas by setting the Page Number and the Elements to show")
    ...
    @Operation(summary = "Get pizzas available by Pages and Elements. ROLE NOT REQUIRED", description = "We are going to retrieve a list of pizzas available by setting the Page Number and the Elements to show")
    ...
    @Operation(summary = "Get a pizza by id. ROLE NOT REQUIRED", description = "We are going to retrieve a pizza by its id")
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Get a pizza by name. ROLE NOT REQUIRED", description = "We are going to retrieve a pizza by its name")
    ...
    @Operation(summary = "Get pizzas by ingredient. Role ADMIN or CUSTOMER Required", description = "We are going to retrieve a list of pizzas by sending ingredients")
    ...
    @Operation(summary = "Get pizzas excluding ingredient. Role ADMIN or CUSTOMER Required", description = "We are going to retrieve a list of pizzas by excluding ingredients")
    ...
    @Operation(summary = "Save a new pizza. Role ADMIN Required", description = "We are going to create a new pizza and save it")
    @PostMapping()
    ...
    @Operation(summary = "Update a pizza. Role ADMIN Required", description = "We are going to update a pizza and save it")
    @PutMapping()
    ...
    @Operation(summary = "Update a pizza price. Role ADMIN Required", description = "We are going to update a pizza price and save it")
    @PutMapping("/price")
    ...
    @Operation(summary = "Delete a pizza. Role ADMIN Required", description = "We are going to delete a pizza by its id")
